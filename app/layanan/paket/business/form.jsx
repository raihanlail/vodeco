...
const Form = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      setState((prev) => ({ ...prev, isModalOpen: true,  values: initValues,  // Kosongkan form setelah submit
        errors: {}, modalMessage:"Pemesanan berhasil!, proses pembayaran akan dilanjutkan via WA" }));
    }
  };
